...
import ai.pipestream.module.semanticgraph.config.SemanticManagerOptions;
import ai.pipestream.module.semanticgraph.service.ChunkerStreamClient;
import ai.pipestream.module.semanticgraph.service.EmbedderStreamClient;
import ai.pipestream.module.semanticgraph.service.SemanticIndexingOrchestrator;
import ai.pipestream.module.semanticgraph.service.VectorSetResolver;
...
class SemanticIndexingOrchestratorTest {
    ...
    void testConvenienceFields_explicitDirectivesTakePriority() {
        var directiveConfig = new ai.pipestream.module.semanticgraph.config.DirectiveConfig(
                "body", "document.search_metadata.body",
                List.of(new ai.pipestream.module.semanticgraph.config.DirectiveConfig.NamedConfig("chunker-x", null)),
                List.of(new ai.pipestream.module.semanticgraph.config.DirectiveConfig.NamedConfig("minilm", null)),
                null);
